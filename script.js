...
} else /*(((a < 0) && (b > 0)) || ((a > 0) && (b < 0)))*/ { //Правильно что в комментариях, в принципе, данная проверка не целесообразна, но для тренировки - самое то
    c = a + b;
    alert ("Сумма чисел: " + c);
}

// Задание 4 - Отлично, покажу альтернативный способ, похожий
...
// Задание 8 - Не обрабатывается отрицательная степень, выдает ошибку. Покажу на уроке.
